...
public class Game {
    ...
    private View mv;
	public Game(View mv, String playerName, String playerCity) throws IOException {
this.mv=mv;
...
//		WorldMapController w=null;
//		try {
//			w = new WorldMapController(mv.getView(),this,player);
//		} catch (IOException e1) {
//			// TODO Auto-generated catch block
//			e1.printStackTrace();
//		}
//		 mv.getView().getContentPane().removeAll();
//		 mv.getView().getContentPane().add(w.getMap());
//		 mv.getView().revalidate();
//		 mv.getView().repaint();
		DisplayCity dc = null;
		dc=new DisplayCity(mv,this,player,player.getControlledCities().get(0));
