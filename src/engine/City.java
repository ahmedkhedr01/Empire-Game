...
private boolean underSiege;
	...
	public void setEconomicalBuildings(ArrayList<EconomicBuilding> ec) {
		economicalBuildings=ec;
	}
	public void setMilitaryBuildings(ArrayList<MilitaryBuilding> mc) {
		militaryBuildings=mc;
	}
